...
API_ID = int(environ.get('API_ID', '22237124'))
API_HASH = environ.get('API_HASH', '3ed92051ab8064684d8b1a5babd79ec8')
BOT_TOKEN = environ.get('BOT_TOKEN', "7775980936:AAE2ruW0KZZvRb8vO0BZ9RPWCeu70vsBzjE")
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002220670718'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '0'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002220670718')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002370487322').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1002220670718')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '0')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002220670718').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002220670718').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kannadam851:GNd1AEngyHEn6rVZ@cluster0.ksecq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://kannadam851:GNd1AEngyHEn6rVZ@cluster0.ksecq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002315762201'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/How_to_Download_01211hh')  # How to open tutorial link for verification
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/DVITTALKANNADAMOVIE')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/DVITTALKANNADAMOVIE')  # Support group link (make sure bot is admin)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002167205597')).split()]
